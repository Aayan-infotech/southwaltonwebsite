...
const ForgotPassword = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      await axios.post('http://18.209.197.35 :5001/api/auth/send-email', { email });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://18.209.197.35 :5001/api/auth/verify-otp', { email, otp });
