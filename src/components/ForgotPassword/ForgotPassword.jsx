...
const ForgotPassword = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      await axios.post('http://44.196.192.232:5001/api/auth/send-email', { email });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://44.196.192.232:5001/api/auth/verify-otp', { email, otp });
