  ...
  //       if (user) {
  //         try {
  //           const response = await axios.get(`http://18.209.197.35 :5001/api/user/${user}`);
  ...
  //     e.preventDefault();
  //     try { 
  //       const response = await axios.put(`http://18.209.197.35 :5001/api/user/${user}`, userData);
  ...
  // export default ProfileUpdate;
    ...
    //     try {
    //       const response = await axios.put(`http://18.209.197.35 :5001/api/user/${user}`, formData, {
    //         headers: {
...
const ProfileUpdate = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://18.209.197.35 :5001/api/user/user/${user}/`, { newPassword: newPassword });
