...
const Agreement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!signature) {
      alert('Please sign before submitting.'); // Check if signature is provided
      return;
    }

    const userId = localStorage.getItem('user')?.replace(/"/g, ''); // Get user ID from localStorage
    if (!userId) {
      alert('User ID not found. Please log in again.'); // Check if user ID exists
      return;
    }
      ...
      <div >
        <div className='Agree'>
          <div className='user-details'>
            {/* <div className='first'>
                    <div className='name'>
                        Name of renter &#x28; Reasonable Party &#x29;
                        <input type="text" />
                    </div>
                    <div className='email'>
                        Email Address
          ...
          <div>
            ...
            <p>
              For comments or concerns, please let us know how we are doing by emailing us at southwaltongolfcartrentals@gmail.com
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                Before using the cart, please inspect it and take photos of any existing damage. All previous damage must be reported to us before using the cart to avoid damage charges to your credit card. Photos can be sent to southwaltongolfcartrentals@gmail.com or 850-797-0284.
          ...
          <div>
            ...
            <p>
              This agreement states that the responsible party will select and abide by one of the terms for the delivery of the rental cart. The responsible party must choose <strong>YES</strong> for one option and <strong>NO</strong> for the other. The first option is free, while the second option incurs an additional fee of $150. This policy is in place to ensure there are no excuses for not sending check-in photos.
            </p>
            <h4>Option 1: YES OR NO</h4>
            <p><em>(This option is free and is chosen by most customers.)</em></p>
            <p>
              By selecting <strong>YES</strong> for this option, the responsible party agrees to take photos (within 10 hours of delivery) of all pre-existing damage. This includes, but is not limited to:
            </p>
            <ul>
              <li>Scratches that remove paint</li>
              <li>Curbed wheels</li>
              <li>Dents in the rear step</li>
              <li>Tears in the seats</li>
              <li>Scratches on the roof</li>
              <li>Scratches on the seat pod</li>
              <li>Broken blinker arms</li>
              <li>Damaged molding</li>
              <li>Any other damage from top to bottom of the cart</li>
            </ul>
            <p>
              These photos must be reported to <a href="tel:8507970284">850-797-0284</a> or <a href="mailto:southwaltongolfcartrentals@gmail.com">southwaltongolfcartrentals@gmail.com</a>, with the license plate number and your name in the subject line. Failure to take check-in photos means the customer agrees to assume responsibility for all damage found by South Walton Carts LLC upon the pickup damage report.
            </p>
            <p>
              Furthermore, the responsible party agrees not to slander this agreement or leave negative reviews on any platforms (including but not limited to Facebook, Google, Yelp, TripAdvisor, etc.) regarding charges for damage when check-in photos were not provided or did not show the damage identified by South Walton Carts at the time of pickup. By choosing this option, the responsible party agrees to these terms. The photos taken will be compared with our damage report at the time of pickup.
            </p>

            <h4>Option 2: YES OR NO</h4>
            <p><em>(This option incurs an additional $150 fee.)</em></p>
            <p>
              By selecting <strong>YES</strong> for this option, South Walton Carts will provide the responsible party with a damage inspection report via email, including time-stamped photos of all pre-existing damage reported before the cart is delivered. This report will be used to compare any and all damages during the cart pickup.
            </p>

            <p>
              Please be on the lookout for a check-in/welcome email prior to delivery. Set a reminder to take check-in photos of all damage and again before you leave! Thank you, and have a great vacation!
            </p>
