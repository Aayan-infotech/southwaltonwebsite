...
const handleClear = () => {
  ...
  //               const response = await axios.post('http://18.209.197.35:5001/api/sign/save', formData, {
  //                   headers: {
  ...
  //   // try {
  //   //   await axios.post('http://18.209.197.35:5001/api/sign/save', { 
  //   //     userId,
...
const handleSubmit = async (e) => {
  ...
  if (uploadedFile && userId) {
    try {
      ...
      const uploadResponse = await axios.post('http://18.209.197.35:5001/api/sign/save', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      ...
      const pdfResponse = await axios.post('http://18.209.197.35:5001/generate-pdf', { userId });
      ...
      const updatePdfResponse = await axios.put('http://18.209.197.35:5001/api/sign/update-pdf', {
        userId,
