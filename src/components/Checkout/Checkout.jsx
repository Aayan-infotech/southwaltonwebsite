      ...
      <form className="booking-form" onSubmit={handleSubmit}>
        ...
        <div className="home3-details">
          <div className="location-input">
            <div className="input-wrapper">
              <label><i className="fa-solid fa-location-dot"></i> Delivery</label>
              <Autocomplete onLoad={(ref) => deliveryRef.current = ref} onPlaceChanged={() => handlePlaceChanged('deliveryLocation', deliveryRef)}>
                <input
                  type="text"
                  name="deliveryLocation"
                  placeholder="Enter Your Delivery Location"
            ...
            <div className="input-wrapper">
              <label><i className="fa-solid fa-location-dot"></i> Pickup</label>
              <Autocomplete onLoad={(ref) => pickupRef.current = ref} onPlaceChanged={() => handlePlaceChanged('pickupLocation', pickupRef)}>
                <input
                  type="text"
                  name="pickupLocation"
                  placeholder="Enter Your Pickup Location"
