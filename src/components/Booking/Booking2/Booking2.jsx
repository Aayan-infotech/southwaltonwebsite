...
//       await axios.put(`http://18.209.197.35 :5001/api/vehicle/removecart/${id}`, { status });
//       fetchModels();
//     } catch (error) {
...
//                 <img src={`http://18.209.197.35 :5001/uploads/${model.image}`} alt={model.vname} className="cart-image" />
